...
from functions import parseccoef as pc
from functions import parsecexport

def parsec(pparray, output = False):
    # I/O files path
    path = 'data/'
    ...
    if output:
        ...
        fpath = os.path.join(path, f'{pparray}.dat')
        ...
        plt.savefig(os.path.join(path,f'{pparray}.pdf'))
        plt.savefig(os.path.join(path,f'{pparray}.png'))
